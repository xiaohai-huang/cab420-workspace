# It updates week 9 Solutions for Task 2 and Task 3, where
# Task 2 uses Test_set and features selected by “PRM_training_bm25_wk9.py”  (file PModel_w5_R102.dat).
...
if __name__ == "__main__":
    ...
    # get features
    os.chdir('..')
    featureFile = open('PModel_w5_R102.dat')
    ...
    wFile = open('PR102_test_ranks.dat', 'w')
    ...
    rank1={}
    i=1
    for line in open("PR102_test_ranks.dat"):
        line = line.strip()
        line1 = line.split()
        rank1[str(i)] = line1[0]
        i = i + 1
